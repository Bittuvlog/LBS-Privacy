...
<!-- Start Main-->
<h1 align="center">Decrypted Data Successfully</h1>
<br/>
...
// Function to decrypt date and time
function decryptDateTime($encryptedDateTime) {
  // You need to use the same decryption algorithm and key as used in encryption
...
<tr>
       ...
       <td><?php echo $latitude=str_openssl_dec($row['latitude'],$iv); ?></td>
       <td><?php echo  $longitude=str_openssl_dec($row['longitude'],$iv);?></td>
       <!-- <td><?php// $encryptedDateTime=$row['date'];?></td> -->
       <td><?php 
        $encryptedDateTime=$row['date'];
         $decryptedDateTime = decryptDateTime($encryptedDateTime);
        echo $decryptedDateTime; ?></td>
